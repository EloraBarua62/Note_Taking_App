...
export const addNote = createAsyncThunk("notes/addNote", async (data) => {
  const res = await axios.post(
    "https://note-taking-app-server.onrender.com/new_note",
    data
  );
  // await axios.post('https://note-taking-app-server.onrender.com/new_note', data);
  console.log(res);
  console.log(res.data);
  return res.data;
});
...
export const updateNote = createAsyncThunk("notes/updateNote", async (data) => {
  const note = {
    ...
    email: data.email,
    note: data.newNote,
    noteDate: data.updatedDate,
  };
  console.log(note);
  const res = await axios.put(
    `https://note-taking-app-server.onrender.com/update_note/${data.id}`,
    note
  );
  console.log(res);
  // console.log(res.data)
...
export const deleteNote = createAsyncThunk(
  ...
  async (id, email) => {
    const res = await axios.delete(
      `https://note-taking-app-server.onrender.com/delete_note/${id}`,
      { email: email }
    );
    console.log(res);
    console.log(res.data);
