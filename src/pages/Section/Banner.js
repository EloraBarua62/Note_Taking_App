...
const Banner = () => {
    return (
        <div className='w-full bg-slate-900 grid grid-cols-1 md:grid-cols-2 px-20 py-10 md:py-0'>
            <div className='flex-col justify-center my-auto text-center md:text-left'>
