  ...
  return (
    <div className="w-full h-full flex justify-center item-center bg-amber-400 py-20">
      <div className="w-11/12">
        <h1 className="text-center text-3xl font-bold text-slate-600 uppercase pb-10">
          Recent notes
        </h1>
        <div className="w-full flex justify-center">
          <input
            ...
            className="my-10 border-2 rounded-md border-slate-500 py-2 pl-3 w-4/6 lg:w-1/4"
          />
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {noteLists &&
            noteLists
              ...
              .map((noteDetails) => (
                <div className="bg-amber-200 w-3/4 border rounded-md shadow-2xl mx-auto">
                  <h1 className="text-slate-700 my-3 pl-3 text-lg font-semibold">
                    {noteDetails.title}{" "}
                  </h1>
                  ...
                  <div className="w-full h-60 bg-amber-100 pl-3 text-slate-700 overflow-y-scroll ">
                    ...
                    <p className="pb-10 font-semibold">
                      Created on : {noteDetails.noteDate}
                    </p>
                    <label
                      type="submit"
                      onClick={() => handleView(noteDetails)}
                      for="view-modal"
                      className=" text-4xl font-semibold pr-3"
                    >
                    ...
                    <label
                      ...
                      for="update-modal"
                      className=" text-2xl font-semibold  pr-3"
                    >
                      <FaRegEdit></FaRegEdit>
                    </label>
                    <button
                      type="submit"
                      onClick={() =>
                        handleDelete(noteDetails._id, noteDetails.email)
                      }
            ...
            <div class="modal modal-bottom sm:modal-middle">
              <div class="modal-box bg-slate-700">
                ...
                <div class="modal-action">
                  <label
                    for="view-modal"
                    class="btn bg-white hover:bg-slate-200 text-black"
                  >
                    Close
                  </label>
                </div>
